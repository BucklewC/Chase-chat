...
const MyChatBot = () => {
  ...
  const Q1Options = ["Yes, I want to see if I am eligible for compensation", "Existing Client", "Something Else"]
	...
	const flow={
        ...
        function: (params) ==> setForm({...form, initial_question:})
        options: Q1Options,
      ...
      message: "Are you contacting us today about yourself, or someone else?"
		...
		end_success: {
			message: "We've received your information and will be in contact with you as soon as possible using the contact information you provided. " 
      + 
        "Thank you for contacting Kreindler & Kreindler LLP.",
		},
    end_unqualified: {
